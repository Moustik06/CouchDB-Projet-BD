...
public class Reader {
    ...
    public List<Agence> agencesReader() throws IOException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            // {"_id":1,"_id_employer":"[1,2,5,7,4,9]","_id_parking":1,"nom":"Marie-noël","adresse":"Apt
            // 919","telephone":"9524496346"}
    ...
    public List<Assurance> assurancesReader() throws IOException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            // [{"_id":1,"_id_vehicule":1,"type":"tier","nom_assurance":"Waelchi
            // Inc","prix_assurance":155.7},
    ...
    public List<Client> clientsReader() throws IOException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            // {"_id":1,"nom":"De Zuani","prenom":"Josée","adresse":"12th
            // Floor","telephone":"3662217370","email":"edezuani0@flavors.me"},
    ...
    public List<Employer> employersReader() throws IOException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            // [{"_id":1,"_id_agence":1,"nom":"Ovenden","prenom":"Måns","adresse":"Apt
            // 1229","telephone":"5492994392","emploi":"chef"},
    ...
    public List<Location> locationsReader() throws IOException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            Location location = new Location(id, id_client, id_vehicule, id_agence, id_employer, date_debut, date_fin,
                    id_parkingRecup, id_parkingRendu, prix_ttc);
            id++;
    ...
    public List<Vehicule> vehiculesReader() throws IOException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            // [{"_id":1,"_id_agence":1,"marque":"Suzuki","modele":"Grand
            // Vitara","prix":174.43,"caution":459.19,"plaque_imat":"WAUJFAFH7BN867243"},
